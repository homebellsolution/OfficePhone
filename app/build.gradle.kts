...
val packageName = "com.multicraft.multivox"
...
android {
    ...
    defaultConfig {
        buildConfigField("String", "SIP_ACCOUNT_DOMAIN", "\""")
        manifestPlaceholders += mapOf()
        applicationId = packageName
        minSdk = 28
        targetSdk = 35
        versionCode = 1008 // 6.00.010
        versionName = "1.0.0.8"
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                output.outputFileName = "MultiVox-android-${variant.buildType.name}-$versionName.apk"
            }
    }
