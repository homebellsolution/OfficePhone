...
class HelpViewModel
    ...
    private val _openPlayStoreEvent = MutableLiveData<EventMine<String>>()
    val openPlayStoreEvent: LiveData<EventMine<String>> = _openPlayStoreEvent
    ...
    fun checkForUpdate1() {
        ...
        val playStoreUrl = "https://play.google.com/store/apps/details?id=com.multicraft.multivox"
        _openPlayStoreEvent.postValue(EventMine(playStoreUrl))
...
open class EventMine<out T>(private val content: T) {
