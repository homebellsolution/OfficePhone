...
class HelpFragment : GenericMainFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.translateTitle.visibility = View.GONE
        binding.translateSubtitle.visibility = View.GONE
        binding.advancedTitle.visibility = View.GONE
        binding.debugIcon.visibility = View.GONE
        binding.debugTitle.visibility = View.GONE
        binding.debugSubtitle.visibility = View.GONE

        viewModel.openPlayStoreEvent.observe(viewLifecycleOwner) { event ->
