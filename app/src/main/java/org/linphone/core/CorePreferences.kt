...
class CorePreferences
    ...
    var firstLaunch: Boolean
        get() = config.getBool("app", "first_6.0_launch", true) // Allow App Intro Screen
        set(value) {
    ...
    var showFavoriteContacts: Boolean
        get() = config.getBool("ui", "show_favorites_contacts", true) // false
        set(value) {
    ...
    var enableSecureMode: Boolean
        get() = config.getBool("ui", "enable_secure_mode", false) // true Don't Take Screen Shot
        set(value) {
    ...
    val hidePhoneNumbers: Boolean
        get() = config.getBool("ui", "hide_phone_numbers", false) // hide phone contact from menu
    ...
    val hideAdvancedSettings: Boolean
        get() = config.getBool("ui", "hide_advanced_settings",  true) // false
    ...
    val thirdPartySipAccountDefaultDomain: String
       // get() = config.getString("ui", "assistant_third_party_sip_account_domain", "")!!
        get() = BuildConfig.SIP_ACCOUNT_DOMAIN
